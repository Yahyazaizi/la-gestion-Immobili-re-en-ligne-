            ...
            <div class="container">
                ...
                <div class="row about-company">
                    ...
                    <div class="col-md-12 col-lg-5 mt-5">
                        <video id="background-video" autoplay muted playsinline class="w-100 h-100 position-absolute" style="object-fit: cover;" src="admin/upload/<?php echo $row['3'];?>" type="video/mp4"></video>
                    </div>
                </div>
