...
<body class="<?php echo (isset($_COOKIE['darkmode']) && $_COOKIE['darkmode'] === 'active') ? 'darkmode' : ''; ?>">
...
<!-- <div id="page-wrapper"> -->
    <div class="row"> 
        ...
        <div class="full-row">
            <div class="container">
                ...
                <div class="dashboard-personal-info p-5  ">
    ...
    $userImage =!empty($row['uimage']) ? 'admin/user/' . htmlspecialchars($row['uimage']) : 'admin/user/user-profile-min.png';;
     ?>
                            <img src="<?php echo $userImage; ?>" alt="userimage">
</div>
